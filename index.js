...
if (!isRegistrar) return reply(mess.registro)//PEDI O REGISTRO
				...
				if (!isRegistrar) return reply(mess.registro)//PEDI O REGISTRO
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* Lukera\n*WPP:* wa.me/+5516991766933\n*INSTA:* @luke.ra\n\n\nEspero que tenham gostado do bot 🥵'})
					  client.sendMessage(from, 'Ctt do meu dono ai Wa.me/5516991766933 , pfv n flode',MessageType.text, { quoted: freply} )
                    break
